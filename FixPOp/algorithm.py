...
class GA:
    ...
    def is_dominant(self, ind_1, ind_2):
        # 0: dont dorminant, 1: dorminant, 2: dominant


       if ind_1.adv_score > ind_2.adv_score and ind_1.psnr_score > ind_2.psnr_score:
           return 1

       elif ind_1.adv_score < ind_2.adv_score and ind_1.psnr_score < ind_2.psnr_score:
           return 2
...
class NSGAII:
    ...
    def is_dominant(self, ind_1, ind_2):
       ...
       if (ind_1.adv_score >= ind_2.adv_score and ind_1.psnr_score > ind_2.psnr_score) or (ind_1.adv_score > ind_2.adv_score and ind_1.psnr_score >= ind_2.psnr_score): 
           return 1
       if (ind_1.adv_score <= ind_2.adv_score and ind_1.psnr_score < ind_2.psnr_score) or (ind_1.adv_score < ind_2.adv_score and ind_1.psnr_score <= ind_2.psnr_score): 
