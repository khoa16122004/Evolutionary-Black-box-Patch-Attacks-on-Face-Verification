...
def get_model(model_name, device='cuda'):
    if model_name == "resnet_vggface":     
        model = InceptionResnetV1("vggface2")
        # cp_pack = "pretrained_model/vggface2.pt"
        cp_pack = os.path.join(PRETRAINED_MODEL_PATH, "vggface2.pt")
        
    elif model_name == "resnet_webface":
        model =  InceptionResnetV1("casia-webface")
        # cp_pack = "pretrained_model/webface.pt"
        cp_pack = os.path.join(PRETRAINED_MODEL_PATH, "webface.pt")
   
    elif model_name == "restnet_vggface_student":
        # model = torch.load("pretrained_model/resnet_vggface_distill.pth")
        model = torch.load(os.path.join(PRETRAINED_MODEL_PATH, "resnet_vggface_distill.pth"))
        return model 
    ...
    # elif model_name == "symbolic_reg":
        ...
        cp_pack = os.path.join(PRETRAINED_MODEL_PATH, "bisenet.pth")
